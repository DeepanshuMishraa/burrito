...
The initial implementation intentionally uses these pinned MLX Community conversions as a temporary release exception because Burrito-produced artifacts do not exist yet. Their repository revisions remain immutable in code; replace them with verified Burrito-owned conversions before declaring the model catalog production-ready.
